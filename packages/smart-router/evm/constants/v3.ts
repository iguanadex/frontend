...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0xB44Aed60Ed5b7234d4dE39252205712d8bA3F14A',
  [ChainId.ETHERLINK]: '0xfE0AA9Fe4aDB5C05D95B3a5B6B50023a2B77c553',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ETHERLINK_TESTNET]: '0xb199D829bc9c750D12A4B6af9C1D16Eae54Eb7e8',
  [ChainId.ETHERLINK]: '0x52435A505b643862988F26A86e2469B9b1613c4c',
} as const satisfies Record<ChainId, Address>
